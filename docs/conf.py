...
latex_documents = [
    ("index", "Delorean.tex", "Delorean Documentation", "Mahdi Yusuf", "manual"),
]
...
man_pages = [("index", "Delorean", "Delorean Documentation", ["Mahdi Yusuf"], 1)]
...
texinfo_documents = [
    (
        ...
        "Mahdi Yusuf",
        "Delorean",
        "Delorean is a library provides easy and convenient datetime conversions in Python.",
        "Miscellaneous",
    ),
]
